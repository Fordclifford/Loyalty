...
public class Infinia {
	...
	@Column(name="VALUEX6")
    private String valueX6;
	
	@Column(name="VALUEX7")
    private String valueX7;
	...
	public String getValueX6() {
		return valueX6;
	}

	public void setValueX6(String valueX6) {
		this.valueX6 = valueX6;
	}

	public String getValueX7() {
		return valueX7;
	}

	public void setValueX7(String valueX7) {
